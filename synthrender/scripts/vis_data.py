...
if __name__ == "__main__":
    ...
    if vis_option == "coco":
            command = ["blenderproc", "vis", vis_option, "-b", os.path.join(config["output_dir"], "coco"), "-i", str(frame_id)]


    elif vis_option == "hdf5":
            command = ["blenderproc", "vis", vis_option, os.path.join(config["output_dir"], "hdf5", f"{frame_id}.hdf5")]
