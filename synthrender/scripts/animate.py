...
if __name__ == "__main__":
    ...
    extcam_setup.set_up_keyframes(num_layouts=num_layouts, interp_time=interp_time, 
                            pause_time=paused_time, camera_rps=camera_rps, cam_dist=8, cam_height=3)
    ...
    if not debugmode:
        ...
        if mp4:
            ...
            for camera_id in cameras:
                ...
                output_dir = os.path.join(cfg_output_dir, "animations", f"animation_{camera_id}_frames")
                sequence = os.path.join(output_dir, 'rgb_*.png') # pattern of files: RGB_0001.png, RGB_0002.png, …
                output = os.path.join(cfg_output_dir, "animations", f'animation_{camera_id}.mp4')
